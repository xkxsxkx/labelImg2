...
# from PySide2.QtCore import Slot, Signal, SIGNAL, SLOT
...
class Ip4Edit(QLineEdit):
    def __init__(self, parent = None):
      ...
      self.ip_part1.setText(str(0))
      self.ip_part2.setText(str(0))
      self.ip_part3.setText(str(0))
      self.ip_part4.setText(str(0))
    ...
    def textChangedSlot(self, text):
      ippart1 = int(self.ip_part1.text())
      ippart2 = int(self.ip_part2.text())
      ippart3 = int(self.ip_part3.text())
      ippart4 = int(self.ip_part4.text())

      ipaddr = QString('{0}.{1}.{2}.{3}')\
          .format(ippart1, ippart2,
              ippart3, ippart4)
